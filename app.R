          ...
          tabItem(tabName = "quick_facts",
                  fluidRow(
                              box(width = 12, title = paste("Latest numbers as of", latest_date), solidHeader = TRUE, status = "primary",
                                  ...
                                  h3(round((get_value_by_date(reported_cases, latest_date, "Positive Total")-get_value_by_date(reported_cases, latest_date-7, "Positive Total"))/7),
                                     "average  daily cases reported over last week.  Compared to ",
                                     round((get_value_by_date(reported_cases, latest_date-7, "Positive Total")-get_value_by_date(reported_cases, latest_date-14, "Positive Total"))/7),
                                     "from a week ago."),
